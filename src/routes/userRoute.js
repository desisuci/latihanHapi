...
const createUserHandler = async (request, h) => {
    try {
        const { firstNameReq, lastNameReq, emailReq, genderReq, registerDateReq, completedReq } = request.payload
...
const patchUserHandler = async (request, h) => {
    try {
        ...
        const { firstNameReq, lastNameReq, emailReq, genderReq, registerDateReq, completedReq } =
            request.payload;
